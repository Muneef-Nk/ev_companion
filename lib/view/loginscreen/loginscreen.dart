        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text("Please login to continue",style: TextStyle(fontSize: 15.5,fontWeight: FontWeight.bold),),
            ),
            Form( 
              child: 
              Column(
                    ...
                    // remind me radio button
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text("Remind me next time",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15.5),),
                        ...
                        child: Row(
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Text("Sign up", style: TextStyle(fontWeight: FontWeight.bold,color: ColorConstants.primaryColor,fontSize: 14),))
                          ],
                        ),
                      )
          ],
